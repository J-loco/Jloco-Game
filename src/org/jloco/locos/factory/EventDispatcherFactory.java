package org.jloco.locos.factory;
...
import org.jloco.locos.eventbus.SyncMessageEvent;
...
public class EventDispatcherFactory {
    ...
    public void init() {
        Reflections reflections = new Reflections(new ConfigurationBuilder().forPackage("org.jloco.locos.eventbus").setScanners(new SubTypesScanner(false), new MethodAnnotationsScanner()));
