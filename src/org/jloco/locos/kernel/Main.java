package org.jloco.locos.kernel;
...
import org.jloco.locos.database.data.game.HeroicMobsGroupsData;
import org.jloco.locos.database.data.login.ServerData;
...
import org.jloco.locos.exchange.ExchangeClient;
import org.jloco.locos.game.GameServer;
import org.jloco.locos.game.scheduler.Updatable;
import org.jloco.locos.game.scheduler.entity.WorldPub;
...
public class Main {
    ...
    public static void start() {
        ...
        String configPath = System.getenv().getOrDefault("JLOCO_CONFIG_PATH", "game.config.properties");
